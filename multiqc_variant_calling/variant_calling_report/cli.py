...
disable_variant_calling_report = click.option('--disable-variant-calling-report', 'disable_variant_calling_report',
    is_flag = True,
    help = "Disable the variant_calling_report MultiQC plugin on this run"
)